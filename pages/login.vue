<template>
  <div class="bg-white rounded-xl shadow-lg flex max-w-[1140px] w-full mx-auto h-[600px] max-h-[80vh] my-10">
    <!-- Left Side: Image and Text -->
    <div class="relative w-1/2 rounded-l-xl overflow-hidden">
      <NuxtImg src="/auth-bg.png" format="avif,webp" alt="Basketball player" class="object-cover w-full h-full" />
    ...
    <div class="w-1/2 p-6 flex flex-col justify-center">
      <h2 class="text-2xl font-bold mb-2">Sign in to <span class="text-red-800">CoachCall</span></h2>
      <p class="text-gray-600 mb-4">Welcome to CoachCall, please enter your login details below using the app</p>
      <form class="space-y-3">
        <div>
          ...
          <div class="flex items-center border rounded-lg px-3 py-2">
            ...
            <input id="email" type="email" placeholder="Login details" class="w-full outline-none" >
          </div>
        </div>
        <div>
        ...
        <div class="flex items-center justify-between">
          ...
          <p class="text-red-800 text-sm">Forgot Password</p>
        </div>
        <button type="submit" class="w-full bg-red-800 text-white py-2 rounded-lg hover:bg-red-900 transition">
          Login
        </button>
      </form>
      <p class="text-center mt-3 text-sm">
        No account yet? <nuxt-link to="/register" class="text-red-800">Register</nuxt-link>
      </p>
    </div>
  </div>
</template>
...
// Add login form logic here (e.g., API calls)
</script>